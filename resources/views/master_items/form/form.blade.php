<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        @if (isset($data_item) && $data_item->foto)
            <img src="{{ asset('uploads/foto_items/' . $data_item->foto) }}" alt="Foto Item" width="100"
                class="mt-2 rounded">
        @endif
    </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="kategori_item_id" required>
